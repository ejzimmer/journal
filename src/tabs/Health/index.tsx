...
const exercises = [
  {
    ...
    updates: [
      ...
      {
        date: Temporal.PlainDate.from('2026-08-16'),
        update:
          '2 x 5 x 3 mats + 1 low yoga block + 1 high yoga block, 1 x 5 3 mats + 2 low yoga blocks (eccentric only)',
      },
    ],
  ...
  },
  {
    ...
    updates: [
      ...
      { date: Temporal.PlainDate.from('2026-08-15'), update: '3 x 10 x 20kg' },
      { date: Temporal.PlainDate.from('2026-08-17'), update: '3 x 10 x 20kg' },
    ],
  },
];
